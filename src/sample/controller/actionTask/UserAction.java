...
return searchedPatient;
    ...
    */
    ...
    private static String getStringMedical(MedicalOfficer medicalOfficer){
        String editMedicalOfficer = medicalOfficer.getUserRoll()+ ","
                + medicalOfficer.getName() + ","
                + medicalOfficer.getGender() + ","
                + medicalOfficer.getMaritalStatus()+","
                + medicalOfficer.getDob()+","
                + medicalOfficer.getPhoneNumber()+","
                + medicalOfficer.getIdCardNumber()+","
                + medicalOfficer.getAddress()+","
                + medicalOfficer.getUserName()+","
                + medicalOfficer.getUserPassword()+","
                + medicalOfficer.getStaffID() + ","
                + medicalOfficer.getStaffEmailAddress()+","
    ...
    private  static String getStringReceptionist(Receptionist receptionist){
        String editReceptionist = receptionist.getUserRoll()+ ","
